<!-- Menu -->
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboards -->
                    <li class="menu-item {{ request()->routeIs('admin.index', 'admin.crm') ? 'active open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ request()->routeIs('admin.crm') ? 'active' : '' }}">
                                <a href="{{ route('admin.crm') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ request()->routeIs('admin.users.*') ? 'active open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ request()->routeIs('admin.users.account') ? 'active' : '' }}">
                                <a href="{{ route('admin.users.account') }}" class="menu-link">
                                    <div data-i18n="Account">Account</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.users.billing') ? 'active' : '' }}">
                                <a href="{{ route('admin.users.billing') }}" class="menu-link">
                                    <div data-i18n="Billing">Billing</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.users.connections') ? 'active' : '' }}">
                                <a href="{{ route('admin.users.connections') }}" class="menu-link">
                                    <div data-i18n="Connections">Connections</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.users.notifications') ? 'active' : '' }}">
                                <a href="{{ route('admin.users.notifications') }}" class="menu-link">
                                    <div data-i18n="Notifications">Notifications</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.users.security') ? 'active' : '' }}">
                                <a href="{{ route('admin.users.security') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ request()->routeIs('admin.invoices.*') ? 'active open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ request()->routeIs('admin.invoices.add') ? 'active' : '' }}">
                                <a href="{{ route('admin.invoices.add') }}" class="menu-link">
                                    <div data-i18n="Add">Add</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.invoices.edit') ? 'active' : '' }}">
                                <a href="{{ route('admin.invoices.edit') }}" class="menu-link">
                                    <div data-i18n="Edit">Edit</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.invoices.preview') ? 'active' : '' }}">
                                <a href="{{ route('admin.invoices.preview') }}" class="menu-link">
                                    <div data-i18n="Preview">Preview</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.invoices.print') ? 'active' : '' }}">
                                <a href="{{ route('admin.invoices.print') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ request()->routeIs('admin.access-roles', 'admin.access-permission') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base ti tabler-lock"></i>
                            <div data-i18n="Access">Access</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ request()->routeIs('admin.access-roles') ? 'active' : '' }}">
                                <a href="{{ route('admin.access-roles') }}" class="menu-link">
                                    <div data-i18n="Roles">Roles</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.access-permission') ? 'active' : '' }}">
                                <a href="{{ route('admin.access-permission') }}" class="menu-link">
